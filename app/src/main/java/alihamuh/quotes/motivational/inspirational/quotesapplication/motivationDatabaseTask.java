...
public class motivationDatabaseTask extends AsyncTask<String, Void, ArrayList<CompleteQuote>> {

    private Context mContext;
    //private Cursor result;

    public motivationDatabaseTask(Context context){
...
*/
    ...
    protected ArrayList<CompleteQuote> doInBackground(String...strings) {
        ...
        Cursor result = mDBHlpr.getReadableDatabase().query("motivation",
